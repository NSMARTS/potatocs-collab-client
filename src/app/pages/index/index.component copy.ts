...
export class IndexComponent implements OnInit, AfterViewInit {
    ...
    onScroll(event) {
        ...
        // 정운님
        // this.isVisualActive = this.isElementInViewport(this.visualRef.nativeElement);
        // console.log('this.isVisualActive 클래스 네임 변경', this.isVisualActive);

        // this.isContentsActive = this.isElementInViewport(this.contentsRef.nativeElement);
        // console.log('this.isContentsActive 클래스 네임 변경', this.isContentsActive);

        // this.isworksCardsActive = this.isElementInViewport(this.worksCardRef.nativeElement);
        // console.log('this.isworksCardsActive 클래스 네임 변경', this.isworksCardsActive);

        this.prevScrollTop = nowScrollTop;
    }

    // 요소의 뷰포트 진입 여부 확인하는 함수
